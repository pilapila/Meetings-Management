...
2. Clone this into your local machine using the terminal (mac) or Gitbash (PC) `> git clone https://github.com/pilapila/Meetings-Management.git`
3. CD to the folder `cd Meetings-Management`
